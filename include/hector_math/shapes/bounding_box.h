                                                              ...
                                                              const Isometry3 <Scalar> &transform )
{
  ...
  // @formatter:on
  Eigen::Matrix<Scalar, 3, 8> transformed_corners = transform * corners;
  auto row_wise = transformed_corners.rowwise();
  Vector3<Scalar> min = row_wise.minCoeff();
  Vector3<Scalar> max = row_wise.maxCoeff();

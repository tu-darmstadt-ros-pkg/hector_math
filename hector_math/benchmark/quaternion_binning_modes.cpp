...
{
  for(auto _:state){
    auto index = computeBin<Scalar,AXIS_BINS,ANGLE_COUNT,mode>(Eigen::Quaternion<Scalar>::UnitRandom());
...
BENCHMARK_TEMPLATE( quaternionBinning,float, QuaternionBinningMode::SphericalFibonacci, 128,512)->Unit( benchmark::kNanosecond )->Iterations( 2000000 );
BENCHMARK_TEMPLATE( quaternionBinning,double, QuaternionBinningMode::SphericalFibonacci, 128,512)->Unit( benchmark::kNanosecond )->Iterations( 2000000 );

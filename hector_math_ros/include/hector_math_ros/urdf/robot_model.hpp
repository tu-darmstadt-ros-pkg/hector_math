...
public:
   ...
   */
  explicit UrdfRobotModel( urdf::ModelConstSharedPtr model,
   ...
   */
  explicit UrdfRobotModel( urdf::ModelConstSharedPtr model, std::vector<std::string> joint_names,
...
protected:
  ...
  urdf::ModelConstSharedPtr model_;
  LinkTree link_tree_;
